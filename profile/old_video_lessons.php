										...
										<div class="fcrse_1 mt-30">
											<a href="#" class="fcrse_img">
												<?php if ($lesson_resalt['cover'] == "") {
													...
													$pro_img = "../dashboard/images/lesson/cover/" . $lesson_resalt['cover'];
																...
																if ($vmonth < $current_d) {
																	if ($numrows > 0) {
																		while ($row = $check_select->fetch_assoc()) {
																			if ($row['count'] >= $view_count) { ?>
																				<a href="student_profile.php" class="save_btn btn-block" style="background-color:red;">Video Count Expired</a>
																			<?php } else { ?>
																				<form action="view_count.php" method="post">
																					<input type="hidden" name="video_id" value="<?php echo $lesson_resalt['lid']; ?>">

																					<input type="submit" class="save_btn btn-block" style="background-color:#151fc1;" value="Watch Lesson">
																				</form>
																		<?php }
																		}
