								...
								<div class="table-responsive">
									<table id="example1" class="table table-bordered">
										...
										<tbody>
											...
											$stmt = $DB_con->prepare('SELECT * FROM lmsclasstute_std where tid="' . $_SESSION['tid'] . '" and ctype = "notes" ORDER BY ctuid');
											...
											?>
													<tr>
														...
														<td>
															<a class="btn btn-primary" href="edit_notes.php?cttid=<?php echo $row["ctuid"]; ?>">
																<i class="fa fa-edit"></i>
															</a>
															<a class="btn btn-danger" href="delete_notes.php?cttid=<?php echo $row["ctuid"]; ?>">
											...
											<div class="card">
												<div class="card-body">
													<div class="text-center">
														...
														<a class="btn btn-primary btn-rounded mt-3 px-4" href="edit_notes.php?cttid=<?php echo $row["ctuid"]; ?>">
															<i class="fa fa-edit"></i>
														</a>
														<a class="btn btn-danger btn-rounded mt-3 px-4" href="delete_notes.php?cttid=<?php echo $row["ctuid"]; ?>">
															<i class="fa fa-times-circle"></i>
														</a>
													</div>
												</div>
