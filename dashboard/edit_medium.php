...
if (isset($_POST['update'])) {
    ...
    if (!isset($errMSG)) {
        ...
        if ($stmt->execute()) {
            ...
            $successMSG = "Medium Successfully Updated ...";

            header("refresh:2;medium.php"); // redirects image view page after 5 seconds.
        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="medium.php">Medium</a></li>
                    <li class="breadcrumb-item active"><a href="edit_admin.php">Edit Medium</a></li>
                </ol>
            </div>
        </div>
                        ...
                        <form action="" method="POST" enctype="multlmsrt/form-data">
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <a class="btn btn-light" href="medium.php"><i class="fa fa-times"></i> Close</a>
                                </div>
                            </div>
                        </form>
                    </div>
