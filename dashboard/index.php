					...
					<div class="authincation-content">
						<div class="row no-gutters">
							<div class="col-xl-12">
								<div class="auth-form">
									<p>
										<center class="mt-5"><img src="settings/logo/<?php echo $main_logo; ?>" class="img-fluid w-75"></center>
									</p>
									<h4 class="text-center mb-4" style="font-weight:bold;color:#000000;">Login in Admin Panel</h4>
									<hr>
									<h1 style="background-color: #ff0000; color: #000000; width: 100%; font-size: 18px; text-align: center;"><?php if (isset($error)) {
																																					echo $error;
																																				} ?></h1>
