                    ...
                    <div id="list-view" class="tab-pane fade active show col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="add_medium.php" class="btn btn-square btn-secondary">+ Add Medium</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_medium.php?clid=<?php echo $row["cid"]; ?>" class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>
                                                            <a href="delete_medium.php?clid=<?php echo $row["cid"]; ?>" class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a>
                                                        </td>
                                                    </tr>
                                            <?php
                                                }
