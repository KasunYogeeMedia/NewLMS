					...
					<div id="list-view" class="tab-pane fade active show col-lg-12">
						<div class="card">
							<div class="card-header">
								...
								<a href="add_class_schedule.php" class="btn btn-square btn-secondary float-right">+ Add Class Schedule</a>
							</div>
							<div class="card-body">
											...
											?>
												<tr>
													...
													<td><?php if ($subject_resalt['image'] == "") {
															...
															$pro_img = "../dashboard/images/class/" . $subject_resalt['image'];
											...
											<div class="card-body">
												<div class="text-center">
													...
													<ul class="list-group mb-3 list-group-flush">
														...
														<li class="list-group-item px-0 d-flex justify-content-between">
															<span class="mb-0">Grade : </span><strong><?php echo $level_resalt['name']; ?></strong>
														</li>
														...
														<li class="list-group-item px-0 d-flex justify-content-between">
															<span class="mb-0">Month :</span><strong><span class="badge badge-success" style="font-size:14px;"> <?php echo date_format(date_create($list_resalt['add_date2']), "F"); ?></span></strong>
														</li>
