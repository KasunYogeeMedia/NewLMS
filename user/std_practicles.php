...
<div class="content-wrapper p-2 ml-0 pt-5 video">
    <div class="content_head pt-2">
        ...
        $result = $query->fetch();
        ?>
        <h4 class="text-center">Practicals by Students <?php echo $result['name']; ?></h4>
    </div>
    <div class="content_body text-center pt-2">
        <table id="example1" class="table table-dark table-bordered">
            ...
            <tbody>
                ...
                $stmt = $DB_con->prepare('SELECT * FROM lmslesson WHERE type = "student_practicals" AND subject = "' . $gid . '"  ORDER BY lid');
