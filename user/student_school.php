        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    $result = $query->fetch();
                    ?>
                    <h4 class="text-center"> - Student School Papers <?php echo $result['name']; ?></h4>
                </td>
            </tr>
        </table>
    </div>
    <div class="content_body text-center pt-2">
        <table id="example1" class="table table-dark table-bordered">
            ...
            <tbody>
                ...
                $stmt = $DB_con->prepare('SELECT * FROM lmsclasstute_std WHERE ctype = "School Papers" AND subject = "' . $gid . '" AND tid = "' . $sid . '" ORDER BY ctuid');
